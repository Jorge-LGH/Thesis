...
regions <- read.delim("1_Data/Created_data/output_dir_CNV_postdoublet_SkipChecks/
                      HMM_CNV_predictions.HMMi6.hmm_mode-samples.Pnorm_0.4.pred_cnv_regions.dat")
probs <- read.delim("1_Data/Created_data/output_dir_CNV_postdoublet_SkipChecks/
                    BayesNetOutput.HMMi6.hmm_mode-samples/CNV_State_Probabilities.dat")
...
ref.data.HPCA <- readRDS("1_Data/HPCA_celldex.rds")
...
ref.data.BED <- readRDS("1_Data/BlueprintEncode_celldex.rds")
...
#--------------------Last processing of seurat object--------------------
